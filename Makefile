...
$(OUTPUT): main.o sdl.o singleton.o renderer.o rendererGL.o entity.o texture.o
	gcc $(CFLAGS) main.o sdl.o singleton.o renderer.o rendererGL.o types.o texture.o entity.o -o $(OUTPUT)
